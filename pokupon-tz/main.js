...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.ngOnInit = function () {
        this.form = new _node_modules_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            searchField: new _node_modules_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', _node_modules_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
            searchSystem: new _node_modules_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', _node_modules_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required)
        });
    };
    SearchComponent.prototype.onSubmit = function () {
        if (this.form.invalid) {
            ...
            this.preSubmitInvalid = false;
            var system = this.form.get('searchSystem').value;
            var request = this.form.get('searchField').value.split(' ').join('+');
            document.location.href = this.getUrl(system, request);
        }
    };
    SearchComponent.prototype.getUrl = function (system, request) {
        if (system === 'ask.com') {
...
module.exports = __webpack_require__(/*! C:\Users\irina\Desktop\search\src\main.ts */"./src/main.ts");
